...
int main(void)
{
  ...
  xTaskCreate(SenderTask, "Humidity Sender Task", 100, (void *)&(xStructToSend[0]), 2, &hum_task_handle);

  xTaskCreate(SenderTask, "pressure Sender Task", 100, (void *)&(xStructToSend[1]), 2, &press_task_handle);
